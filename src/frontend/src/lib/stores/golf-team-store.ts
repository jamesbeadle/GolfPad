...
function createGolfTeamStore() {
  ...
  async function getGolfTeamRequests(
  ...
  async function updateGolfTeamPicture(
    dto: UpdateGolfTeamPicture,
  ): Promise<void> {
  ...
  async function removeGolfTeamMember(
    dto: RemoveGolfTeamMember,
  ): Promise<void> {
