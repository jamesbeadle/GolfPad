...
function createTournamentStore() {
  ...
  async function updateTournamentStage(
    dto: UpdateTournamentStage,
  ): Promise<any> {
  ...
  async function getTournamentInstance(
    dto: GetTournamentInstance,
  ): Promise<TournamentInstance | undefined> {
