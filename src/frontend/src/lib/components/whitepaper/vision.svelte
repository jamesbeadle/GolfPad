...
<div class="flex flex-col space-y-2">
  ...
  <p>
  	GolfPad is the Web3 evolution that golf needs. Designed to enhance gameplay for players of all levels, GolfPad introduces innovative features to expand your game. It also enriches the social and club experience, offering unique games that make this already vibrant community sport even more engaging.
  </p>
