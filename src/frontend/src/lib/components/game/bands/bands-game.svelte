<script lang="ts">
    ...
    import BandsComplete from "./bands-complete.svelte";
    import BandsPlay from "./bands-play.svelte";
    import BandsPredict from "./bands-predict.svelte";
...
{#if Object.keys(game.status)[0] == 'Active'}
    <BandsPlay {game} {players} {golfCourse} />
{/if}
