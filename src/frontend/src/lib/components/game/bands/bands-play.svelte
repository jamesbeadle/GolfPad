<script lang="ts">
    ...
    import type { Game, GolfCourseTeeGroup, GolferSummary, BandsScores, AddGameScore, GameScoreSubmission, BandsScore, BandsHoleResult, BandsCategory } from "../../../../../../declarations/backend/backend.did";
    ...
    function completeCategory(golferId: string, category: BandsCategory){
        playerResults = playerResults.filter(r => r.golferId !== golferId && Object.keys(r.category)[0] == Object.keys(category)[0]);
    ...
    <div class="flex flex-col w-full">
        ...
        <div class="p-4">
            ...
            <div class="mb-4">
                ...
                {#each playerHoleTargets as target}
                    <div class="flex flex-row">
                        <div class="w-1/3">
                            <UserProfileHorizontal golfer={players.find(x => x.principalId == target.golferId)!} />
                        </div>
                        <div class="w-1/3">
