...
module {
  public class GolfChannelManager() {
    ...
    private var golfChannelCanisterIndex: TrieMap.TrieMap<T.GolfChannelId, Base.CanisterId> = TrieMap.TrieMap<T.GolfCourseId, Base.CanisterId>(Utilities.eqNat, Utilities.hashNat);
    ...
    public func channelExists(channelId: T.GolfChannelId) : Bool {
      let course = golfChannelCanisterIndex.get(channelId);
