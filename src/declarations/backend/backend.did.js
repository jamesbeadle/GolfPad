export const idlFactory = ({ IDL }) => {
  ...
  const Result_13 = IDL.Variant({ ok: AppStatus, err: Error });
  ...
  const Result_12 = IDL.Variant({ ok: GolfCourse, err: Error });
  ...
  const Result_11 = IDL.Variant({ ok: Golfer, err: Error });
  ...
  const Result_10 = IDL.Variant({ ok: FantasyLeaderboard, err: Error });
  ...
  const Result_7 = IDL.Variant({ ok: Prediction, err: Error });
  ...
  const Result_9 = IDL.Variant({ ok: Profile, err: Error });
  ...
  const Result_8 = IDL.Variant({ ok: ProjectCanisters, err: Error });
  ...
  const Result_6 = IDL.Variant({ ok: Tournament, err: Error });
  const GetTournamentInstance = IDL.Record({
    year: IDL.Nat16,
    tournamentId: TournamentId,
  });
  const GolfRound = IDL.Record({
    hole14Score: IDL.Nat8,
    hole7Score: IDL.Nat8,
    hole2Score: IDL.Nat8,
    hole17Score: IDL.Nat8,
  ...
  const TournamentLeaderboardEntry = IDL.Record({
    golferId: GolferId,
    totalShots: IDL.Nat,
    rounds: IDL.Vec(GolfRound),
    tournamentId: TournamentId,
  });
  const TournamentLeaderboard = IDL.Record({
    totalEntries: IDL.Nat,
    entries: IDL.Vec(TournamentLeaderboardEntry),
  });
  ...
  const TournamentInstance = IDL.Record({
    endDate: IDL.Int,
  ...
  const Result_5 = IDL.Variant({ ok: TournamentInstance, err: Error });
  ...
  return IDL.Service({
    ...
    getAppStatus: IDL.Func([], [Result_13], ["query"]),
    getGolfCourse: IDL.Func([GetGolfCourse], [Result_12], ["query"]),
    getGolfer: IDL.Func([GetGolfer], [Result_11], ["query"]),
    getLeaderboard: IDL.Func([GetFantasyLeaderboard], [Result_10], ["query"]),
    getPrediction: IDL.Func([GetPrediction], [Result_7], ["query"]),
    getProfile: IDL.Func([GetProfile], [Result_9], ["query"]),
    getProjectCanisters: IDL.Func([], [Result_8], []),
    getScorecard: IDL.Func([GetScorecard], [Result_7], ["query"]),
    getTournament: IDL.Func([GetTournament], [Result_6], ["query"]),
    getTournamentInstance: IDL.Func(
