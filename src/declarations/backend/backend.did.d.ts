...
export interface GetTournamentInstance {
  year: number;
  tournamentId: TournamentId;
}
...
export type Result_10 = { ok: FantasyLeaderboard } | { err: Error };
export type Result_11 = { ok: Golfer } | { err: Error };
export type Result_12 = { ok: GolfCourse } | { err: Error };
...
export type Result_5 = { ok: TournamentInstance } | { err: Error };
export type Result_6 = { ok: Tournament } | { err: Error };
export type Result_7 = { ok: Prediction } | { err: Error };
export type Result_8 = { ok: ProjectCanisters } | { err: Error };
export type Result_9 = { ok: Profile } | { err: Error };
...
export interface TournamentLeaderboard {
  totalEntries: bigint;
  entries: Array<TournamentLeaderboardEntry>;
}
export interface TournamentLeaderboardEntry {
  golferId: GolferId;
  totalShots: bigint;
  rounds: Array<GolfRound>;
  tournamentId: TournamentId;
}
...
export interface _SERVICE {
  ...
  getGolfCourse: ActorMethod<[GetGolfCourse], Result_12>;
  getGolfer: ActorMethod<[GetGolfer], Result_11>;
  getLeaderboard: ActorMethod<[GetFantasyLeaderboard], Result_10>;
  getPrediction: ActorMethod<[GetPrediction], Result_7>;
  getProfile: ActorMethod<[GetProfile], Result_9>;
  getProjectCanisters: ActorMethod<[], Result_8>;
  getScorecard: ActorMethod<[GetScorecard], Result_7>;
  getTournament: ActorMethod<[GetTournament], Result_6>;
  getTournamentInstance: ActorMethod<[GetTournamentInstance], Result_5>;
