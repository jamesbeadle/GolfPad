import { t as M, a as L, c as fe } from "../chunks/CfcDVdrG.js";
import { i as we } from "../chunks/Bv5W8DTh.js";
import {
  h as se,
  F as ne,
  E as be,
...
import { w as De, e as A } from "../chunks/BweNXA1K.js";
import { i as N } from "../chunks/B64lGz8y.js";
import { e as ce, i as de } from "../chunks/H0vPu0gU.js";
import { c as Ne } from "../chunks/B8dPJ5Vu.js";
import { s as R } from "../chunks/CjjwH-_m.js";
import { t as Re, s as ge } from "../chunks/LbqoZVd0.js";
import { s as $e, L as Ge } from "../chunks/CIYIwWpX.js";
import { a as Oe, s as z } from "../chunks/BMJTtVcc.js";
import { p as Z } from "../chunks/CWiu2rbl.js";
import { a as We } from "../chunks/uWWjYOZy.js";
function me(t, e, s, a) {
  var o = t.__style;
  if (se || o !== e) {
    var c = Re(e);
    (!se || c !== t.getAttribute("style")) &&
...
function ve() {
  const t = D.now();
  D.tasks.forEach((e) => {
    e.c(t) || (D.tasks.delete(e), e.f());
  }),
    D.tasks.size !== 0 && D.tick(ve);
}
function Ue(t) {
  let e;
  return (
...
function H(t, e, s, a) {
  ...
  var v = {
    ...
    I = ne;
  if (((I.transitions ?? (I.transitions = [])).push(v), o && Oe)) {
    var x = d;
    if (!x) {
      for (var u = I.parent; u && u.f & be; )
        for (; (u = u.parent) && !(u.f & xe); );
      x = !u || (u.f & ke) !== 0;
    }
    x &&
      Ie(() => {
...
function ee(t, e, s, a, o) {
  ...
  if ((s?.deactivate(), !e?.duration))
    return o(), { abort: F, deactivate: F, reset: F, t: () => a };
  const { delay: i = 0, css: r, tick: l, easing: w = Ce } = e;
  var b = [];
  if (c && s === void 0 && (l && l(0, 1), r)) {
    var E = pe(r(0, 1));
    b.push(E, E);
  }
  var B = () => 1 - a,
    v = t.animate(b, { duration: i });
  return (
    (v.onfinish = () => {
      var I = s?.t() ?? 1 - a;
      s?.abort();
      var x = a - I,
        u = e.duration * Math.abs(x),
        f = [];
      if (u > 0) {
        var j = !1;
        if (r)
          for (
            var T = Math.ceil(u / 16.666666666666668), P = 0;
            P <= T;
            P += 1
          ) {
            var $ = I + x * w(P / T),
              _ = pe(r($, 1 - $));
            f.push(_), j || (j = _.overflow === "hidden");
          }
        j && (t.style.overflow = "hidden"),
          (B = () => {
            var G = v.currentTime;
            return I + x * w(G / u);
          }),
      ...
      (v = t.animate(f, { duration: u, fill: "forwards" })),
        (v.onfinish = () => {
          (B = () => a), l?.(a, 1 - a), o();
        });
    }),
...
function ue(t, { delay: e = 0, duration: s = 400, easing: a = He } = {}) {
  const o = +getComputedStyle(t).opacity;
  return { delay: e, duration: s, easing: a, css: (c) => `opacity: ${c * o}` };
}
function he(
  t,
  {
  ...
  const m = getComputedStyle(t),
    d = +m.opacity,
    i = m.transform === "none" ? "" : m.transform,
    r = 1 - o,
    l = d * (1 - c);
  return {
    delay: e,
...
function W(t, e) {
  Te(e, !1);
  const s = k();
  let a = Z(e, "showModal", 8),
    o = Z(e, "onClose", 8),
    c = Z(e, "useFixedPosition", 8, !1),
    m = k(),
    d = k(),
    i = !1;
  const r = (x) => {
  ...
  typeof window < "u" && window.addEventListener("keydown", r),
    We(() => {
      typeof window < "u" &&
  ...
  const l = (x) => {
      const u = document.querySelector('[role="dialog"]'),
        f = x.target;
      !u?.contains(f) && !i && o()();
    },
    w = () => {
  ...
  J(
    ...
    () => {
      typeof window < "u" &&
        a() &&
        (y(m, window.scrollY), y(d, window.innerWidth < 768));
    },
  ),
    J(
      () => (n(d), n(m)),
      () => {
        y(
          s,
          n(d)
            ? n(m) + window.innerHeight * 0.45
            : n(m) + window.innerHeight / 2,
        );
      },
    ),
    J(
      ...
      $e(T, e, "default", {}),
        ...
        O(() => {
          ge(
            f,
            1,
            `border-2 shadow-md rounded-lg border-BrandPurple/50 ${(c() ? "absolute" : "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2") ?? ""} 
           w-full max-w-lg px-4 md:px-0`,
          ),
            me(
              f,
              c()
                ? `top: ${n(s)}px; transform: translate(-50%, -50%); left: 50%;`
                : "",
            );
        }),
        H(
...
function $t(t) {
  let e = k("vision"),
    s = "top";
  const a = [
    { name: "Vision", component: ze },
    { name: "Merve", component: Qe },
    { name: "New Games", component: gt },
    { name: "Side Games", component: ot },
    { name: "Marketing", component: vt },
    { name: "Road Map", component: wt },
  ];
  function o() {
    const i = a.findIndex((r) => r.name.toLowerCase() === n(e));
    i < a.length - 1 && y(e, a[i + 1].name.toLowerCase());
  }
  function c() {
    const i = a.findIndex((r) => r.name.toLowerCase() === n(e));
    i > 0 && y(e, a[i - 1].name.toLowerCase());
  }
  function m(i) {
    return a[i].name.toLowerCase() === n(e);
  }
  function d(i) {
    y(e, a[i].name.toLowerCase());
  }
  Ge(t, {
    children: (i, r) => {
      var l = kt(),
              ...
              ce(
                ...
                (S, U, X, It) => {
                  ...
                  O(
                    (ye) => {
                      ge(V, 1, ye),
                        R(V, "aria-label", `Go to ${a[X].name} section`);
                    },
                    [
                      () => `
                ...
                O(
                  (S, U) => {
                    (Q.disabled = S), (te.disabled = U);
                  },
                  [
                    () =>
                      a.findIndex((S) => S.name.toLowerCase() === n(e)) === 0,
                    () =>
                      a.findIndex((S) => S.name.toLowerCase() === n(e)) ===
                      a.length - 1,
                  ],
                  le,
                ),
