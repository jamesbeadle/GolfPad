import { n as Ie, a as x, c as Ge, t as w } from "../chunks/CfcDVdrG.js";
import { i as Oe } from "../chunks/Bv5W8DTh.js";
import {
  aI as je,
  h as Ne,
  u as Te,
...
import { s as Se } from "../chunks/BMJTtVcc.js";
import { i as C } from "../chunks/B64lGz8y.js";
import { e as Ue, i as ze } from "../chunks/H0vPu0gU.js";
import { s as xe, r as he } from "../chunks/CjjwH-_m.js";
import { s as F, c as Re } from "../chunks/LbqoZVd0.js";
import { l as Ve, e as d } from "../chunks/BweNXA1K.js";
import { s as Ze, b as $e, a as qe } from "../chunks/DpWkRHjp.js";
import { L as Je, u as le } from "../chunks/CIYIwWpX.js";
import { c as Ke, o as Qe, w as We } from "../chunks/uWWjYOZy.js";
import { p as be } from "../chunks/CWiu2rbl.js";
import { b as Xe } from "../chunks/DG1oQLg4.js";
import { L as et } from "../chunks/Ca9TznOk.js";
function we(e, s, p = s) {
  var c = je();
  Ve(e, "input", (n) => {
    var o = n ? e.defaultValue : e.value;
    if (((o = ye(e) ? ke(o) : o), p(o), c && o !== (o = s()))) {
    ...
    ((Ne && e.defaultValue !== e.value) || (Te(s) == null && e.value)) &&
      p(ye(e) ? ke(e.value) : e.value),
    Me(() => {
      var n = s();
      (ye(e) && n === ke(e.value)) ||
...
function Fe(e, s) {
  let p = be(s, "className", 8, ""),
    c = be(s, "fill", 8, "");
  var n = at();
  H(() => {
    F(n, 0, Re(p())), xe(n, "fill", c());
  }),
    x(e, n);
}
var lt = Ie(
...
function ot(e, s) {
  ...
  function g(G) {
    ...
    y.files &&
      y.files[0] &&
      (b(n, !0), (o = y.files[0]), b(D, URL.createObjectURL(y.files[0])));
  }
  function B() {
    o && (c("fileSelect", { file: o, preview: r(D) }), I());
  }
  function re() {
    r(v)?.click();
  }
    ...
    se = V(Z);
  {
    var me = (G) => {
      ...
      t(U),
        ...
        t(y),
        H(
          (f) => (q = F(z, 1, "brand-button", null, q, f)),
          [
            () => ({
              "bg-BrandForest": r(n),
              "text-BrandYellow": r(n),
              "bg-BrandLightGray": !r(n),
              "text-BrandDarkGray": !r(n),
            }),
          ],
          Pe,
        ),
...
function It(e, s) {
  ...
  Qe(async () => {
    try {
      await le.sync(),
        le.subscribe((u) => {
          console.log(u), u && (b(v, u), $e(o, !1));
        });
    } catch (u) {
      console.error("Creating Golfer Error:", u);
    }
  });
  async function me(u) {
    const { file: ie, preview: A } = u.detail;
    b(I, A), b(B, !1);
    try {
      await le.updateProfilePicture(ie),
        await le.cacheProfile(),
        await le.sync();
    } catch (L) {
      console.error("Error updating profile picture:", L);
    }
  }
  async function G(u) {}
  async function y(u) {}
                    ...
                    Q = a(K);
                  {
                    var de = (i) => {
                        var _ = dt(),
                          ...
                          h = l(m, 2),
                          M = a(h);
                        Fe(M, { className: "w-4 h-4", fill: "white" }),
                          t(h),
                          t(_),
                          H(() => xe(m, "src", r(I))),
                          d("click", h, () => b(B, !0)),
                      ...
                      W = (i) => {
                        var _ = ct(),
                          m = l(V(_), 2),
                          h = a(m);
                        Fe(h, { className: "w-20 h-20", fill: "white" }),
                          t(m),
                          d("click", m, () => b(B, !0)),
                          x(i, _);
                      };
                  ...
                  var X = l(Q, 2);
                  {
                    var ee = (i) => {
                      ot(i, {
                        ...
                        $$events: { close: () => b(B, !1), fileSelect: me },
                      });
                    };
                    C(X, (i) => {
                      r(B) && i(ee);
                    ...
                    var ae = (i) => {
                      ...
                      t(ce),
                        ...
                        we(
                          m,
                          () => r(v).username,
                          (k) => Le(v, (r(v).username = k)),
                        ),
                        we(
                          h,
                          () => r(v).handicap[0],
                          (k) => Le(v, (r(v).handicap[0] = k)),
                        ),
                        x(i, _);
                    };
                    C(te, (i) => {
                  ...
                  Ue(
                    ...
                    (ee, T) => {
                      ...
                      t(ve),
                        ...
                        H(
                          (fe) => {
                            Se(h, r(T).principalId), Se(ce, fe);
                          },
                          [() => r(T).principalId.split("_")[0]],
                          Pe,
                        ),
                        d("click", ue, () => G(r(T))),
                        d("click", k, () => y(r(T))),
              ...
              t(Be),
                ...
                H(() => {
                  F(
                    z,
                    1,
                    `px-10 py-3 text-xl text-BrandYellow condensed rounded-l-md rounded-r-none ${(r(g) === "DETAILS" ? "bg-BrandForest" : "bg-[#F9F9F9] text-[#C0C0C0]") ?? ""}`,
                  ),
                    F(
                      q,
                      1,
                      `px-10 py-3 text-xl text-BrandYellow condensed rounded-t-md ${(r(g) === "SOCIAL" ? "bg-BrandForest" : "bg-[#F9F9F9] text-[#C0C0C0]") ?? ""}`,
                    ),
                    F(
                      _e,
                      1,
                      `flex-1 py-2 text-xl condensed ${(r(g) === "DETAILS" ? "bg-BrandForest text-BrandYellow" : "bg-[#F9F9F9] text-[#C0C0C0]") ?? ""}`,
                    ),
                    F(
                      Ae,
                      1,
                      `flex-1 py-2 text-xl condensed ${(r(g) === "SOCIAL" ? "bg-BrandForest text-BrandYellow" : "bg-[#F9F9F9] text-[#C0C0C0]") ?? ""}`,
                    );
                }),
                d("click", z, () => b(g, "DETAILS")),
                d("click", q, () => b(g, "SOCIAL")),
                d("click", _e, () => b(g, "DETAILS")),
                d("click", Ae, () => b(g, "SOCIAL")),
                x(S, Y);
            };
          C(L, (S) => {
            n() ? S(oe) : S(pe, !1);
