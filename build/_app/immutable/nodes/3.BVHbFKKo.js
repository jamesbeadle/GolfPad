import { t as i, a as o } from "../chunks/CfcDVdrG.js";
import { i as N } from "../chunks/Bv5W8DTh.js";
import {
  p as M,
  a as E,
  t as S,
...
import { e as c } from "../chunks/BweNXA1K.js";
import { i as m } from "../chunks/B64lGz8y.js";
import { s as p } from "../chunks/LbqoZVd0.js";
import { s as D, a as P } from "../chunks/DpWkRHjp.js";
import { o as X, w as C } from "../chunks/uWWjYOZy.js";
import { L as R } from "../chunks/CIYIwWpX.js";
var Y = i(
        ...
        r(w),
          ...
          S(() => {
            p(
              u,
              1,
              `text-sm md:text-lg pb-2 focus:outline-none transition-colors duration-300 ${(t() === "Mulligans" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-blue-500") ?? ""}`,
            ),
              p(
                f,
                1,
                `text-sm md:text-lg pb-2 focus:outline-none transition-colors duration-300 ${(t() === "Bands" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-blue-500") ?? ""}`,
              ),
              p(
                x,
                1,
                `text-sm md:text-lg pb-2 focus:outline-none transition-colors duration-300 ${(t() === "Build It" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-blue-500") ?? ""}`,
              ),
              p(
                v,
                1,
                `text-sm md:text-lg pb-2 focus:outline-none transition-colors duration-300 ${(t() === "Next Up" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-blue-500") ?? ""}`,
              );
          }),
          c("click", u, () => l.set("Mulligans")),
          c("click", f, () => l.set("Bands")),
          c("click", x, () => l.set("Build It")),
          c("click", v, () => l.set("Next Up")),
          o(T, b);
      },
      $$slots: { default: !0 },
    }),
