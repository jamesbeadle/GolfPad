import { n as Ie, a as x, c as Ge, t as w } from "../chunks/BMmDdByd.js";
import { i as Oe } from "../chunks/CGhTk5_h.js";
import {
  aK as je,
  h as Ne,
  u as Te,
...
import { s as Se } from "../chunks/ugbJ_z5I.js";
import { i as C } from "../chunks/C5k5KcEQ.js";
import { e as ze, i as Ue } from "../chunks/C8_ZPc39.js";
import { s as xe, r as he } from "../chunks/NaaQUmnV.js";
import { s as F, c as Re } from "../chunks/CfX7pB0F.js";
import { l as Ve, e as d } from "../chunks/Bymeyx8s.js";
import { s as Ze, b as $e, a as qe } from "../chunks/AAG3YkeP.js";
import { L as Ke, u as le } from "../chunks/vBhIH9no.js";
import { c as Je, o as Qe, w as We } from "../chunks/CWqVLV4S.js";
import { p as be } from "../chunks/Bor7tEHN.js";
import { b as Xe } from "../chunks/IeFsPlxR.js";
import { L as et } from "../chunks/LEJbNnwY.js";
function we(e, s, p = s) {
  var c = je();
  Ve(e, "input", (n) => {
    ...
    se = V(Z);
  {
    var me = (G) => {
      ...
      t(z),
        ...
        t(y),
        H(
          (f) => (q = F(U, 1, "brand-button", null, q, f)),
          [
            () => ({
              "bg-BrandForest": r(n),
...
function It(e, s) {
  ...
  async function me(u) {
    const { file: ie, preview: L } = u.detail;
    b(I, L), b(B, !1);
    try {
      ...
      console.error("Error updating profile picture:", A);
    }
  }
  async function G(u) {}
  async function y(u) {}
          ...
          var oe = (S) => {
            ...
            pe = (S) => {
                    ...
                    var ae = (i) => {
                      ...
                      t(ce),
                        ...
                        we(
                          m,
                          () => r(v).username,
                          (k) => Ae(v, (r(v).username = k)),
                        ),
                        we(
                          h,
                          () => r(v).handicap[0],
                          (k) => Ae(v, (r(v).handicap[0] = k)),
                        ),
                        x(i, _);
                    };
                    C(te, (i) => {
              ...
              t(Be),
                ...
                d("click", U, () => b(g, "DETAILS")),
                d("click", q, () => b(g, "SOCIAL")),
                d("click", _e, () => b(g, "DETAILS")),
                d("click", Le, () => b(g, "SOCIAL")),
                x(S, Y);
            };
          C(A, (S) => {
            n() ? S(oe) : S(pe, !1);
