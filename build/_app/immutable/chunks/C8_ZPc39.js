  ...
  W(() => {
    ...
    if (C) {
      for (var p = null, T, c = 0; c < r; c++) {
        if (N.nodeType === 8 && N.data === te) {
          (t = N), (I = !0), k(!1);
          break;
        }
        var n = s[c],
          f = u(n, c);
        (T = J(N, o, p, null, n, f, c, v, e, a)), o.items.set(f, T), (p = T);
      }
      r > 0 && M(B());
    }
    C || ce(s, o, t, v, e, u, a),
...
function ce(l, e, a, u, v, _, t) {
  ...
  for (f = 0; f < h; f += 1) {
    if (((T = l[f]), (c = _(T, f)), (n = d.get(c)), n === void 0)) {
      var K = i ? i.e.nodes_start : a;
      (r = J(K, e, r, r === null ? e.first : r.next, T, c, f, u, v, t)),
        d.set(c, r),
        (E = []),
        (p = []),
        (i = r.next);
    ...
    if (
      (A && he(n, T, f, v),
      n.e.f & S &&
        (X(n.e), o && (n.a?.unfix(), (I ?? (I = new Set())).delete(n))),
      n !== i)
    ) {
      if (s !== void 0 && s.has(n)) {
  ...
  if (i !== null || s !== void 0) {
    for (var H = s === void 0 ? [] : F(s); i !== null; )
      i.e.f & S || H.push(i), (i = i.next);
    var D = H.length;
    if (D > 0) {
      var P = v & G && h === 0 ? a : null;
      if (o) {
        for (f = 0; f < D; f += 1) H[f].a?.measure();
        for (f = 0; f < D; f += 1) H[f].a?.fix();
      }
      oe(e, H, P, d);
    }
  }
